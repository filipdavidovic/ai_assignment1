...
import nl.tue.s2id90.group15.samples.UninformedPlayer;
import nl.tue.s2id90.group15.samples.OptimisticPlayer;
import nl.tue.s2id90.group15.samples.BuggyPlayer;
...
public class MyDraughtsPlugin extends DraughtsPlayerProvider implements DraughtsPlugin {
    public MyDraughtsPlugin() {
        ...
        super(new Group15DraughtsPlayer(5),
